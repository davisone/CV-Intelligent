          ...
          <div className="space-y-3 mb-8">
            ...
            {data.personalInfo.drivingLicenses && (
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-white/90">Permis {data.personalInfo.drivingLicenses}</span>
              </div>
            )}
            {data.personalInfo.linkedin && (
              ...
              >
                ...
                <span className="text-white/90">{data.personalInfo.linkedinLabel || 'LinkedIn'}</span>
              </a>
            )}
                ...
                return (
                  <div className="space-y-5">
                    {categories.map((cat: string) => (
                      <div key={cat}>
                        <h3 className="text-xs font-bold text-white mb-1">{cat}</h3>
