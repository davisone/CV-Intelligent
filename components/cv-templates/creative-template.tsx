          ...
          <div className="space-y-3 mb-8">
            ...
            {data.personalInfo.linkedin && (
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-white/90 break-all text-xs">{data.personalInfo.linkedin}</span>
              </div>
            )}
            {data.personalInfo.github && (
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-white/90 break-all text-xs">{data.personalInfo.github}</span>
              </div>
            )}
          </div>
