...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: buildAlternates('/curriculum-disenador-grafico', locale),
...
const config: SeoLandingConfig = {
  ...
  canonicalPath: '/curriculum-disenador-grafico',
  hero: {
    badgeIcon: Palette,
  },
...
export default function CurriculumDisenadorGraficoPage() {
