...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: buildAlternates('/functional-resume-template', locale),
...
const config: SeoLandingConfig = {
  ...
  canonicalPath: '/functional-resume-template',
  hero: {
    badgeIcon: Sparkles,
  },
...
export default function FunctionalResumeTemplatePage() {
