...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: buildAlternates('/exemples-profil-professionnel', locale),
...
const config: SeoLandingConfig = {
  ...
  canonicalPath: '/exemples-profil-professionnel',
  hero: {
    badgeIcon: FileText,
  },
...
export default function ExemplesProfilProfessionnelPage() {
