...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: buildAlternates('/curriculum-atencion-cliente', locale),
...
const config: SeoLandingConfig = {
  ...
  canonicalPath: '/curriculum-atencion-cliente',
  hero: {
...
export default function CurriculumAtencionClientePage() {
