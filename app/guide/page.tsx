...
export const metadata: Metadata = {
  ...
  description: 'Comment faire un CV parfait ? Guide complet pour créer un CV professionnel : structure, conseils, exemples. Créez votre CV gratuit en ligne avec notre générateur IA.',
  keywords: [
    'comment faire un CV',
    'créer un CV',
    'faire un CV',
